...
.logo-circle {
    ...
    box-shadow: 0 2px 24px rgba(176,144,96,0.12);
}
.brand-name {
...
if predict_clicked:
    ...
    new_df_pred_prob = model.predict_proba(new_df_scaled)
    prob   = new_df_pred_prob[0]
    ...
    ax.set_title("Risk Probability", color='#9e9890', fontsize=9,
